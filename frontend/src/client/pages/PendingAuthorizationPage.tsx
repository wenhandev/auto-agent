      ...
      <div className="flex min-h-screen items-center justify-center bg-background p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardTitle>Device rejected</CardTitle>
            <CardDescription>
              An administrator rejected this device. Contact your org admin or sign
              out and try again.
            </CardDescription>
          </CardHeader>
          <CardContent>
    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Your device is registered but cannot run workflows until an organisation
            admin approves it in Settings → Workers.
          </CardDescription>
        </CardHeader>
